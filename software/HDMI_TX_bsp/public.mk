...
JDI_FILE := $(ABS_BSP_ROOT_DIR)/../../NIOS_HDMI_TX.jdi

# Qsys--generated SOPCINFO file. Required for resolving node instance ID's with 
# design component names. 
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../amax10_qsys.sopcinfo
...
# Design Name 
# setting SOPC_NAME is amax10_qsys
SOPC_NAME := amax10_qsys
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x81050
SOPC_SYSID_FLAG += --sidp=0x81050
ELF_PATCH_FLAG  += --sidp 0x81050

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1485098281
SOPC_SYSID_FLAG += --timestamp=1485098281
ELF_PATCH_FLAG  += --timestamp 1485098281
