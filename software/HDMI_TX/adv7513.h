...
enum adv7513_input_id {
	...
	ADV7513_INPUT_ID_8_10_12BIT_YCBCR422 = 6,
};
...
enum adv7513_vic {
	ADV7513_VIC_VGA_4_3			= 1,	// 640x480p 60Hz
	ADV7513_VIC_480p60_4_3		= 2,	// 720x480p 60Hz
	ADV7513_VIC_480p60_16_9		= 3,	// 720x480p 60Hz
	ADV7513_VIC_720p60_16_9		= 4,	// 1280x720p 60Hz
	ADV7513_VIC_1080i60_16_9	= 5,	// 1920x1080i 60Hz
	ADV7513_VIC_480i60x2_4_3	= 6,	// 720(1440)x480i 60Hz
	ADV7513_VIC_480i60x2_16_9	= 7,	// 720(1440)x480i 60Hz
	ADV7513_VIC_240p60x2_4_3	= 8,	// 720(1440)x240p 60Hz
	ADV7513_VIC_240p60x2_16_9	= 9,	// 720(1440)x240p 60Hz
	ADV7513_VIC_480i60x4_4_3	= 10,	// (2880)x480i 60Hz
	ADV7513_VIC_480i60x4_16_9	= 11,	// (2880)x480i 60Hz
	ADV7513_VIC_240p60x8_4_3	= 12,	// (2880)x240p 60Hz
	ADV7513_VIC_240p60x8_16_9	= 13,	// (2880)x240p 60Hz
	ADV7513_VIC_480p60x2_4_3	= 14,	// 1440x480p 60Hz
	ADV7513_VIC_480p60x2_16_9	= 15,	// 1440x480p 60Hz
	ADV7513_VIC_1080p60_16_9	= 16,	// 1920x1080p 60Hz
	ADV7513_VIC_576p50_4_3		= 17,	// 720x576p 50Hz
	ADV7513_VIC_576p50_16_9		= 18,	// 720x576p 50Hz
	ADV7513_VIC_720p50_16_9		= 19,	// 1280x720p 50Hz
	ADV7513_VIC_1080i50_16_9	= 20,	// 1920x1080i 50Hz
	ADV7513_VIC_576i50x2_4_3	= 21,	// 720(1440)x576i 50Hz
	ADV7513_VIC_576i50x2_16_9	= 22,	// 720(1440)x576i 50Hz
	ADV7513_VIC_288p50x2_4_3	= 23,	// 720(1440)x288p 50Hz
	ADV7513_VIC_288p50x2_16_9	= 24,	// 720(1440)x288p 50Hz
};
...
extern int adv7513_mode_state(struct hdmi_encoder *ec, int *vic, const char **mode);

extern int adv7513_kick_up(struct hdmi_encoder *ec);
extern int adv7513_audio_off(struct hdmi_encoder *ec);
extern int adv7513_audio_on(struct hdmi_encoder *ec);
...
extern int adv7513_chip_init_3d(struct hdmi_encoder *ec, int vic);
