...
static int adv7513_video_in_format(struct hdmi_encoder *ec, int id, int depth, int color_space, int aspect, int style)
{
	...
	if (reg_update_bits(ec, 0x16, 0x3d, regv) != 0)
		return -1;
	if (id == ADV7513_INPUT_ID_12_15_16BIT_RGB444_YCBCR444
			|| id == ADV7513_INPUT_ID_8_10_12BIT_YCBCR422){
		if(reg_update_bits(ec, 0xd0, 0x0c, 0x0c) != 0)
			return -1;

//		if(reg_update_bits(ec, 0x48, 0x18, (1<<3)) != 0)
//			return -1;
		if(reg_update_bits(ec, 0x48, 0x78, 0<<5 | 1<<3) != 0)
			return -1;
	}
...
static int adv7513_video_init(struct hdmi_encoder *ec, int dvi)
{
	...
	// 0x15 0x16 0x17
//	if (adv7513_video_in_format(ec, ADV7513_INPUT_ID_8_10_12BIT_YCBCR422, ADV7513_INPUT_COLOR_DEPTH_8BIT, ADV7513_INPUT_COLOR_SPACE_YCBCR, ADV7513_INPUT_ASPECT_4V3, ADV7513_INPUT_STYLE2) != 0)
//		return -1;
	if (adv7513_video_in_format(ec, ADV7513_INPUT_ID_24BIT_RGB444_YCBCR444, ADV7513_INPUT_COLOR_DEPTH_8BIT, ADV7513_INPUT_COLOR_SPACE_RGB, ADV7513_INPUT_ASPECT_4V3, ADV7513_INPUT_STYLE1) != 0)
			return -1;
//	if(reg_update_bits(ec, 0xd0, 0xf0, 0x70) != 0)
//		return -1;
