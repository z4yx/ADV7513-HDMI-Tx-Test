// amax10_qsys_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module amax10_qsys_mm_interconnect_0 (
		...
		output wire [1:0]  hdmi_tx_int_s1_address,                       //                         hdmi_tx_int_s1.address
		output wire        hdmi_tx_int_s1_write,                         //                                       .write
		input  wire [31:0] hdmi_tx_int_s1_readdata,                      //                                       .readdata
		output wire [31:0] hdmi_tx_int_s1_writedata,                     //                                       .writedata
		output wire        hdmi_tx_int_s1_chipselect,                    //                                       .chipselect
	...
	wire   [7:0] cmd_mux_001_src_channel;                                                          // cmd_mux_001:src_channel -> sysid_qsys_control_slave_agent:cp_channel
	...
	wire  [95:0] cmd_mux_002_src_data;                                                             // cmd_mux_002:src_data -> nios2_gen2_debug_mem_slave_agent:cp_data
	wire         cmd_mux_002_src_ready;                                                            // nios2_gen2_debug_mem_slave_agent:cp_ready -> cmd_mux_002:src_ready
	wire   [7:0] cmd_mux_002_src_channel;                                                          // cmd_mux_002:src_channel -> nios2_gen2_debug_mem_slave_agent:cp_channel
	...
	wire   [7:0] cmd_mux_003_src_channel;                                                          // cmd_mux_003:src_channel -> onchip_memory2_s1_agent:cp_channel
	...
	wire  [96:0] i2c_scl_s1_agent_rf_source_data;                                                  // i2c_scl_s1_agent:rf_source_data -> i2c_scl_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] i2c_scl_s1_agent_rsp_fifo_out_data;                                               // i2c_scl_s1_agent_rsp_fifo:out_data -> i2c_scl_s1_agent:rf_sink_data
	...
	wire         cmd_mux_005_src_valid;                                                            // cmd_mux_005:src_valid -> i2c_scl_s1_agent:cp_valid
	wire  [95:0] cmd_mux_005_src_data;                                                             // cmd_mux_005:src_data -> i2c_scl_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                            // i2c_scl_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [7:0] cmd_mux_005_src_channel;                                                          // cmd_mux_005:src_channel -> i2c_scl_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                                    // cmd_mux_005:src_startofpacket -> i2c_scl_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                      // cmd_mux_005:src_endofpacket -> i2c_scl_s1_agent:cp_endofpacket
	...
	wire  [96:0] i2c_sda_s1_agent_rf_source_data;                                                  // i2c_sda_s1_agent:rf_source_data -> i2c_sda_s1_agent_rsp_fifo:in_data
	...
	wire  [96:0] i2c_sda_s1_agent_rsp_fifo_out_data;                                               // i2c_sda_s1_agent_rsp_fifo:out_data -> i2c_sda_s1_agent:rf_sink_data
	...
	wire         cmd_mux_006_src_valid;                                                            // cmd_mux_006:src_valid -> i2c_sda_s1_agent:cp_valid
	wire  [95:0] cmd_mux_006_src_data;                                                             // cmd_mux_006:src_data -> i2c_sda_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                            // i2c_sda_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [7:0] cmd_mux_006_src_channel;                                                          // cmd_mux_006:src_channel -> i2c_sda_s1_agent:cp_channel
	wire         cmd_mux_006_src_startofpacket;                                                    // cmd_mux_006:src_startofpacket -> i2c_sda_s1_agent:cp_startofpacket
	wire         cmd_mux_006_src_endofpacket;                                                      // cmd_mux_006:src_endofpacket -> i2c_sda_s1_agent:cp_endofpacket
	wire  [31:0] hdmi_tx_int_s1_agent_m0_readdata;                                                 // hdmi_tx_int_s1_translator:uav_readdata -> hdmi_tx_int_s1_agent:m0_readdata
	wire         hdmi_tx_int_s1_agent_m0_waitrequest;                                              // hdmi_tx_int_s1_translator:uav_waitrequest -> hdmi_tx_int_s1_agent:m0_waitrequest
	wire         hdmi_tx_int_s1_agent_m0_debugaccess;                                              // hdmi_tx_int_s1_agent:m0_debugaccess -> hdmi_tx_int_s1_translator:uav_debugaccess
	wire  [19:0] hdmi_tx_int_s1_agent_m0_address;                                                  // hdmi_tx_int_s1_agent:m0_address -> hdmi_tx_int_s1_translator:uav_address
	wire   [3:0] hdmi_tx_int_s1_agent_m0_byteenable;                                               // hdmi_tx_int_s1_agent:m0_byteenable -> hdmi_tx_int_s1_translator:uav_byteenable
	wire         hdmi_tx_int_s1_agent_m0_read;                                                     // hdmi_tx_int_s1_agent:m0_read -> hdmi_tx_int_s1_translator:uav_read
	wire         hdmi_tx_int_s1_agent_m0_readdatavalid;                                            // hdmi_tx_int_s1_translator:uav_readdatavalid -> hdmi_tx_int_s1_agent:m0_readdatavalid
	wire         hdmi_tx_int_s1_agent_m0_lock;                                                     // hdmi_tx_int_s1_agent:m0_lock -> hdmi_tx_int_s1_translator:uav_lock
	wire  [31:0] hdmi_tx_int_s1_agent_m0_writedata;                                                // hdmi_tx_int_s1_agent:m0_writedata -> hdmi_tx_int_s1_translator:uav_writedata
	wire         hdmi_tx_int_s1_agent_m0_write;                                                    // hdmi_tx_int_s1_agent:m0_write -> hdmi_tx_int_s1_translator:uav_write
	wire   [2:0] hdmi_tx_int_s1_agent_m0_burstcount;                                               // hdmi_tx_int_s1_agent:m0_burstcount -> hdmi_tx_int_s1_translator:uav_burstcount
	wire         hdmi_tx_int_s1_agent_rf_source_valid;                                             // hdmi_tx_int_s1_agent:rf_source_valid -> hdmi_tx_int_s1_agent_rsp_fifo:in_valid
	wire  [96:0] hdmi_tx_int_s1_agent_rf_source_data;                                              // hdmi_tx_int_s1_agent:rf_source_data -> hdmi_tx_int_s1_agent_rsp_fifo:in_data
	wire         hdmi_tx_int_s1_agent_rf_source_ready;                                             // hdmi_tx_int_s1_agent_rsp_fifo:in_ready -> hdmi_tx_int_s1_agent:rf_source_ready
	wire         hdmi_tx_int_s1_agent_rf_source_startofpacket;                                     // hdmi_tx_int_s1_agent:rf_source_startofpacket -> hdmi_tx_int_s1_agent_rsp_fifo:in_startofpacket
	wire         hdmi_tx_int_s1_agent_rf_source_endofpacket;                                       // hdmi_tx_int_s1_agent:rf_source_endofpacket -> hdmi_tx_int_s1_agent_rsp_fifo:in_endofpacket
	wire         hdmi_tx_int_s1_agent_rsp_fifo_out_valid;                                          // hdmi_tx_int_s1_agent_rsp_fifo:out_valid -> hdmi_tx_int_s1_agent:rf_sink_valid
	wire  [96:0] hdmi_tx_int_s1_agent_rsp_fifo_out_data;                                           // hdmi_tx_int_s1_agent_rsp_fifo:out_data -> hdmi_tx_int_s1_agent:rf_sink_data
	wire         hdmi_tx_int_s1_agent_rsp_fifo_out_ready;                                          // hdmi_tx_int_s1_agent:rf_sink_ready -> hdmi_tx_int_s1_agent_rsp_fifo:out_ready
	wire         hdmi_tx_int_s1_agent_rsp_fifo_out_startofpacket;                                  // hdmi_tx_int_s1_agent_rsp_fifo:out_startofpacket -> hdmi_tx_int_s1_agent:rf_sink_startofpacket
	wire         hdmi_tx_int_s1_agent_rsp_fifo_out_endofpacket;                                    // hdmi_tx_int_s1_agent_rsp_fifo:out_endofpacket -> hdmi_tx_int_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_007_src_valid;                                                            // cmd_mux_007:src_valid -> hdmi_tx_int_s1_agent:cp_valid
	wire  [95:0] cmd_mux_007_src_data;                                                             // cmd_mux_007:src_data -> hdmi_tx_int_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                            // hdmi_tx_int_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [7:0] cmd_mux_007_src_channel;                                                          // cmd_mux_007:src_channel -> hdmi_tx_int_s1_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                                    // cmd_mux_007:src_startofpacket -> hdmi_tx_int_s1_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                                      // cmd_mux_007:src_endofpacket -> hdmi_tx_int_s1_agent:cp_endofpacket
	...
	wire  [95:0] nios2_gen2_debug_mem_slave_agent_rp_data;                                         // nios2_gen2_debug_mem_slave_agent:rp_data -> router_004:sink_data
	...
	wire         i2c_scl_s1_agent_rp_valid;                                                        // i2c_scl_s1_agent:rp_valid -> router_007:sink_valid
	wire  [95:0] i2c_scl_s1_agent_rp_data;                                                         // i2c_scl_s1_agent:rp_data -> router_007:sink_data
	wire         i2c_scl_s1_agent_rp_ready;                                                        // router_007:sink_ready -> i2c_scl_s1_agent:rp_ready
	wire         i2c_scl_s1_agent_rp_startofpacket;                                                // i2c_scl_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         i2c_scl_s1_agent_rp_endofpacket;                                                  // i2c_scl_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire  [95:0] i2c_sda_s1_agent_rp_data;                                                         // i2c_sda_s1_agent:rp_data -> router_008:sink_data
	...
	wire         hdmi_tx_int_s1_agent_rp_valid;                                                    // hdmi_tx_int_s1_agent:rp_valid -> router_009:sink_valid
	wire  [95:0] hdmi_tx_int_s1_agent_rp_data;                                                     // hdmi_tx_int_s1_agent:rp_data -> router_009:sink_data
	wire         hdmi_tx_int_s1_agent_rp_ready;                                                    // router_009:sink_ready -> hdmi_tx_int_s1_agent:rp_ready
	wire         hdmi_tx_int_s1_agent_rp_startofpacket;                                            // hdmi_tx_int_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire         hdmi_tx_int_s1_agent_rp_endofpacket;                                              // hdmi_tx_int_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire   [7:0] router_src_channel;                                                               // router:src_channel -> nios2_gen2_data_master_limiter:cmd_sink_channel
	...
	wire   [7:0] nios2_gen2_data_master_limiter_cmd_src_channel;                                   // nios2_gen2_data_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire   [7:0] rsp_mux_src_channel;                                                              // rsp_mux:src_channel -> nios2_gen2_data_master_limiter:rsp_sink_channel
	...
	wire   [7:0] router_001_src_channel;                                                           // router_001:src_channel -> nios2_gen2_instruction_master_limiter:cmd_sink_channel
	...
	wire   [7:0] nios2_gen2_instruction_master_limiter_cmd_src_channel;                            // nios2_gen2_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire   [7:0] rsp_mux_001_src_channel;                                                          // rsp_mux_001:src_channel -> nios2_gen2_instruction_master_limiter:rsp_sink_channel
	...
	wire   [7:0] nios2_gen2_data_master_limiter_cmd_valid_data;                                    // nios2_gen2_data_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire   [7:0] nios2_gen2_instruction_master_limiter_cmd_valid_data;                             // nios2_gen2_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	wire         i2c_scl_s1_agent_rdata_fifo_src_valid;                                            // i2c_scl_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] i2c_scl_s1_agent_rdata_fifo_src_data;                                             // i2c_scl_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         i2c_scl_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_005:in_0_ready -> i2c_scl_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                                // avalon_st_adapter_005:out_0_valid -> i2c_scl_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                                 // avalon_st_adapter_005:out_0_data -> i2c_scl_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                                // i2c_scl_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                                // avalon_st_adapter_005:out_0_error -> i2c_scl_s1_agent:rdata_fifo_sink_error
	wire         i2c_sda_s1_agent_rdata_fifo_src_valid;                                            // i2c_sda_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire  [33:0] i2c_sda_s1_agent_rdata_fifo_src_data;                                             // i2c_sda_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire         i2c_sda_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_006:in_0_ready -> i2c_sda_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_006_out_0_valid;                                                // avalon_st_adapter_006:out_0_valid -> i2c_sda_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_006_out_0_data;                                                 // avalon_st_adapter_006:out_0_data -> i2c_sda_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_006_out_0_ready;                                                // i2c_sda_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire   [0:0] avalon_st_adapter_006_out_0_error;                                                // avalon_st_adapter_006:out_0_error -> i2c_sda_s1_agent:rdata_fifo_sink_error
	wire         hdmi_tx_int_s1_agent_rdata_fifo_src_valid;                                        // hdmi_tx_int_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] hdmi_tx_int_s1_agent_rdata_fifo_src_data;                                         // hdmi_tx_int_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire         hdmi_tx_int_s1_agent_rdata_fifo_src_ready;                                        // avalon_st_adapter_007:in_0_ready -> hdmi_tx_int_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_007_out_0_valid;                                                // avalon_st_adapter_007:out_0_valid -> hdmi_tx_int_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_007_out_0_data;                                                 // avalon_st_adapter_007:out_0_data -> hdmi_tx_int_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_007_out_0_ready;                                                // hdmi_tx_int_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire   [0:0] avalon_st_adapter_007_out_0_error;                                                // avalon_st_adapter_007:out_0_error -> hdmi_tx_int_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) hdmi_tx_int_s1_translator (
		.clk                    (clk_50_clk_clk),                              //                      clk.clk
		.reset                  (jtag_uart_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (hdmi_tx_int_s1_agent_m0_address),             // avalon_universal_slave_0.address
		.uav_burstcount         (hdmi_tx_int_s1_agent_m0_burstcount),          //                         .burstcount
		.uav_read               (hdmi_tx_int_s1_agent_m0_read),                //                         .read
		.uav_write              (hdmi_tx_int_s1_agent_m0_write),               //                         .write
		.uav_waitrequest        (hdmi_tx_int_s1_agent_m0_waitrequest),         //                         .waitrequest
		.uav_readdatavalid      (hdmi_tx_int_s1_agent_m0_readdatavalid),       //                         .readdatavalid
		.uav_byteenable         (hdmi_tx_int_s1_agent_m0_byteenable),          //                         .byteenable
		.uav_readdata           (hdmi_tx_int_s1_agent_m0_readdata),            //                         .readdata
		.uav_writedata          (hdmi_tx_int_s1_agent_m0_writedata),           //                         .writedata
		.uav_lock               (hdmi_tx_int_s1_agent_m0_lock),                //                         .lock
		.uav_debugaccess        (hdmi_tx_int_s1_agent_m0_debugaccess),         //                         .debugaccess
		.av_address             (hdmi_tx_int_s1_address),                      //      avalon_anti_slave_0.address
		.av_write               (hdmi_tx_int_s1_write),                        //                         .write
		.av_readdata            (hdmi_tx_int_s1_readdata),                     //                         .readdata
		.av_writedata           (hdmi_tx_int_s1_writedata),                    //                         .writedata
		.av_chipselect          (hdmi_tx_int_s1_chipselect),                   //                         .chipselect
		.av_read                (),                                            //              (terminated)
		.av_begintransfer       (),                                            //              (terminated)
		.av_beginbursttransfer  (),                                            //              (terminated)
		.av_burstcount          (),                                            //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) hdmi_tx_int_s1_agent (
		.clk                     (clk_50_clk_clk),                                  //             clk.clk
		.reset                   (jtag_uart_reset_reset_bridge_in_reset_reset),     //       clk_reset.reset
		.m0_address              (hdmi_tx_int_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (hdmi_tx_int_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (hdmi_tx_int_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (hdmi_tx_int_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (hdmi_tx_int_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (hdmi_tx_int_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (hdmi_tx_int_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (hdmi_tx_int_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (hdmi_tx_int_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (hdmi_tx_int_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (hdmi_tx_int_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (hdmi_tx_int_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (hdmi_tx_int_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (hdmi_tx_int_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (hdmi_tx_int_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (hdmi_tx_int_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (hdmi_tx_int_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (hdmi_tx_int_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (hdmi_tx_int_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (hdmi_tx_int_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (hdmi_tx_int_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (hdmi_tx_int_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (hdmi_tx_int_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (hdmi_tx_int_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (hdmi_tx_int_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (hdmi_tx_int_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_007_out_0_ready),               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_007_out_0_valid),               //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_007_out_0_data),                //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_007_out_0_error),               //                .error
		.rdata_fifo_src_ready    (hdmi_tx_int_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (hdmi_tx_int_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (hdmi_tx_int_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                           //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                             //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) hdmi_tx_int_s1_agent_rsp_fifo (
		.clk               (clk_50_clk_clk),                                  //       clk.clk
		.reset             (jtag_uart_reset_reset_bridge_in_reset_reset),     // clk_reset.reset
		.in_data           (hdmi_tx_int_s1_agent_rf_source_data),             //        in.data
		.in_valid          (hdmi_tx_int_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (hdmi_tx_int_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (hdmi_tx_int_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (hdmi_tx_int_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (hdmi_tx_int_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (hdmi_tx_int_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (hdmi_tx_int_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (hdmi_tx_int_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (hdmi_tx_int_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                           // (terminated)
		.csr_read          (1'b0),                                            // (terminated)
		.csr_write         (1'b0),                                            // (terminated)
		.csr_readdata      (),                                                // (terminated)
	...
	amax10_qsys_mm_interconnect_0_router router (
	...
	amax10_qsys_mm_interconnect_0_router_001 router_001 (
	...
	amax10_qsys_mm_interconnect_0_router_002 router_002 (
	...
	amax10_qsys_mm_interconnect_0_router_002 router_003 (
	...
	amax10_qsys_mm_interconnect_0_router_004 router_004 (
	...
	amax10_qsys_mm_interconnect_0_router_004 router_005 (
	...
	amax10_qsys_mm_interconnect_0_router_002 router_006 (
	...
	amax10_qsys_mm_interconnect_0_router_002 router_007 (
	...
	amax10_qsys_mm_interconnect_0_router_002 router_008 (
	...
	amax10_qsys_mm_interconnect_0_router_002 router_009 (
		.sink_ready         (hdmi_tx_int_s1_agent_rp_ready),               //      sink.ready
		.sink_valid         (hdmi_tx_int_s1_agent_rp_valid),               //          .valid
		.sink_data          (hdmi_tx_int_s1_agent_rp_data),                //          .data
		.sink_startofpacket (hdmi_tx_int_s1_agent_rp_startofpacket),       //          .startofpacket
		.sink_endofpacket   (hdmi_tx_int_s1_agent_rp_endofpacket),         //          .endofpacket
		.clk                (clk_50_clk_clk),                              //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_50_clk_clk),                                       //        clk.clk
		.reset              (nios2_gen2_reset_reset_bridge_in_reset_reset),         //  clk_reset.reset
	...
	amax10_qsys_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_50_clk_clk),                                              //        clk.clk
		.reset              (nios2_gen2_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	amax10_qsys_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_50_clk_clk),                              //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_50_clk_clk),                              //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_50_clk_clk),                               //       clk.clk
		.reset               (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_50_clk_clk),                               //       clk.clk
		.reset               (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_50_clk_clk),                              //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_50_clk_clk),                              //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_50_clk_clk),                              //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_0_cmd_mux cmd_mux_007 (
		.clk                 (clk_50_clk_clk),                              //       clk.clk
		.reset               (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_50_clk_clk),                              //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_50_clk_clk),                              //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_50_clk_clk),                               //       clk.clk
		.reset              (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_50_clk_clk),                               //       clk.clk
		.reset              (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_50_clk_clk),                              //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_50_clk_clk),                              //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_50_clk_clk),                              //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_0_rsp_demux rsp_demux_007 (
		.clk                (clk_50_clk_clk),                              //       clk.clk
		.reset              (jtag_uart_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_50_clk_clk),                               //       clk.clk
		.reset               (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_50_clk_clk),                               //       clk.clk
		.reset               (nios2_gen2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	amax10_qsys_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	amax10_qsys_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_50_clk_clk),                              // in_clk_0.clk
		.in_rst_0_reset (jtag_uart_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (hdmi_tx_int_s1_agent_rdata_fifo_src_data),    //     in_0.data
		.in_0_valid     (hdmi_tx_int_s1_agent_rdata_fifo_src_valid),   //         .valid
		.in_0_ready     (hdmi_tx_int_s1_agent_rdata_fifo_src_ready),   //         .ready
